...
export default function App() {
  return (
    <div className="App">
      <Box display="flex" flexDirection="column" sx={{ marginX: "40px" }}>
        <Box
          display="flex"
          flexDirection="row"
        ...
        >
          <Box justifySelf="start" display="flex" flex="1">
            <svg
              viewBox="0 0 85 60"
              fill="none"
        ...
        >
          ...
          <CardMedia
            image="https://www.uni.cards/images/nx-wave/nx_wave_hero.png"
            title="card_asset"
            sx={{
              zIndex: 1,
              position: "relative",
